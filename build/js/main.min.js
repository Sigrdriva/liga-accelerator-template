...
var _forSwiper = require("./modules/for-swiper");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    (0, _forSwiper.swiperCoach)();
    (0, _forSwiper.swiperReview)();
    var form = new _form.Form();
    window.form = form;
    form.init();
    (0, _initAccordion.changeActive)();
...
},{"./modules/for-swiper":3,"./modules/form-validate/form":5,"./modules/gym":11,"./modules/init-accordion":12,"./modules/init-tabs":13,"./modules/modals/init-modals":14,"./utils/ios-vh-fix":19}],2:[function(require,module,exports){
"use strict";
...
exports.swiperReview = exports.swiperCoach = void 0;
var _swiper = _interopRequireDefault(require("../vendor/swiper.js"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
var swiperCoach = function swiperCoach() {
  var sliderCoach = new _swiper.default('.coaches__slider', {
    loop: true,
    grabCursor: 'true',
    breakpoints: {
      1366: {
...
exports.swiperCoach = swiperCoach;
var swiperReview = function swiperReview() {
  var sliderReview = new _swiper.default('.reviews__slider', {
    loop: false,
    grabCursor: 'true',
    // breakpoints: {
    //   1366: {
...
exports.swiperReview = swiperReview;

},{"../vendor/swiper.js":21}],4:[function(require,module,exports){
"use strict";
...
var videoButton = document.querySelector('.gym__button');
...
exports.initAccordions = exports.changeActive = exports.accordions = void 0;
...
var changeActive = function changeActive() {
  var activeControl = document.querySelectorAll('.FAQ__control');
  var activeTab = document.querySelectorAll('.FAQ__content .tabs__element');
  var breakpointDesktop = window.matchMedia('(min-width:1366px)');
  var breakpointTablet = window.matchMedia('(min-width:768px) and (max-width:1365px)');
  var breakpointChecker = function breakpointChecker() {
    for (var i = 0; i < activeControl.length; i++) {
      activeControl[i].classList.remove('is-active');
    }
    for (var _i = 0; _i < activeTab.length; _i++) {
      activeTab[_i].classList.remove('is-active');
    }
